...
export var wallSound = new soundFile("score.mp3"); //load sound
...
export var ambientSound = new soundFile("lightrainnoise.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -10; //turn down volume

export var adventureMusic = new soundFile("fairytalesong.mp3");
